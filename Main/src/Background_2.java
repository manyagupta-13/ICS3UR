/*
Background2 Class (Not integrated)
Chris Liu
12/21/2023

Class which creates a background and obstacle hitboxes to create a map (2/3)
*/

import javax.swing.*;
import java.awt.*;

public class Background_2 {
    ...
    public Background_2() {
        ...
        Image map2 = gamefield2.getScaledInstance(ResolWidth2, ResolHeight2, Image.SCALE_SMOOTH);
    }
