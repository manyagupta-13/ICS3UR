public class Background_1 {
    ...
    private Hitbox stand1n3;
    private Hitbox stand2n3;
    private Hitbox obstaclen3;
    private Hitbox groundn3;
    ...
    public Background_1() {
        ...
        Image map3 = gamefield.getScaledInstance(ResolWidth3, ResolHeight3, Image.SCALE_SMOOTH);

    }

    public void setStand1Hitbox3() {
        stand1n3 = new Hitbox(hitboxPlayer1x3, hitboxPlayer1y3, hitboxPlayer1W3, hitboxPlayer1L3);
    }

    public void setStand2Hitbox3() {
        stand2n3 = new Hitbox(hitboxPlayer2x3, hitboxPlayer2y3, hitboxPlayer2W3, hitboxPlayer2L3);
    }

    public void setObstacleHitbox3() {
        obstacle3 = new Hitbox(ObstacleX3, ObstacleY3, ObstacleW3, ObstacleL3);
    }

    public void setGroundHitbox3() {
        ground3 = new Hitbox(GroundX3, GroundY3, GroundW3, GroundL3);
    }
